...
namespace negocio
{
    public class PokemonNegocio
    {
        public List<Pokemon> listar()
        {
            ...
            try
            {                       // A DONDE ME CONECTO(serv)--  A que Base de Datos -    COMO ME CONECTO 
                ...
                while (lector.Read())
                {
                    ...
                    //if (!lector.IsDBNull(lector.GetOrdinal("UrlImagen"))) // VALIDAR CON IF
        ...
        public void agregar(Pokemon nuevo)
        {
            ...
            try
            {
                datos.setearConsulta("Insert into POKEMONS (Numero, Nombre, Descripcion, IdTipo, IdDebilidad, Activo, UrlImagen) values(" + nuevo.Numero + ",'" + nuevo.Nombre + "', '" + nuevo.Descripcion + "',1, @IdTipo, @IdDebilidad, @UrlImagen)");
