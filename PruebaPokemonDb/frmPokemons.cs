...
namespace PruebaPokemonDb
{
    public partial class Form1 : Form
    {
        ...
        private void cargarImagen(string imagen)
        {
            ...
            {
                pbxPokemon.Load("https://cdn-icons-png.flaticon.com/512/10809/10809585.png");
            }
        }
        ...
        private void eliminar(bool logico = false)
        {
            ...
            try
            {
                DialogResult respuesta = MessageBox.Show("Desea eliminar el pokemon definitivamente?", "Eliminando", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
